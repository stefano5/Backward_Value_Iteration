...
#include "backward_value_iteration.h"
 ...
 *
 * */
void Graph::compute_optimal_cost(int N, std::string node_xf) {
 ...
 *
 * */
std::string Graph::_get_optimal_path(std::string starting_node) {
 ...
 *
 * */
std::vector<Node> Graph::get_optimal_path(std::string starting_node) {
